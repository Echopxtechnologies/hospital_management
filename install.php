...
// ==========================================
// TABLE 5: hospital_visits (Main Visit Record)
// ==========================================
if (!$CI->db->table_exists(db_prefix() . 'hospital_visits')) {
    ...
    $CI->db->query("CREATE TABLE `" . db_prefix() . "hospital_visits` (
        ...
        `patient_id` INT(11) NOT NULL COMMENT 'FK to hospital_patients',
        `appointment_id` INT(11) DEFAULT NULL COMMENT 'FK to hospital_appointments',
        `consultant_id` INT(11) NOT NULL COMMENT 'FK to staff table',
...
// ==========================================
// TABLE 6: hospital_visit_details (Extended Visit Info)
// ==========================================
